...
This probability is an integral of the posterior density. The question is why an average of simulated values can stand in for that integral. [**Monte Carlo integration**](https://bruno.nicenboim.me/bayescogsci/ch-introstan.html) makes the connection using random draws from the target distribution.
