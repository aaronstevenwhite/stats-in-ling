...
Basically, we apply the same rule to every sample the model could have produced and collect the resulting estimates. More specifically, the distribution of that estimation rule across possible samples is its [**sampling distribution**](https://appliedstatisticsforlinguists.org/bwinter_stats_proofs.pdf#page=173).
...
Using the [expectation rule developed earlier](../random-variables-and-distributions/expected-values.qmd), its expected value is
