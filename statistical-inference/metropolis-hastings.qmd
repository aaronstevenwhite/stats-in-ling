...
The [**Metropolis-Hastings algorithm**](https://bookdown.org/rdpeng/advstatcomp/markov-chain-monte-carlo.html) constructs a Markov chain for this target by proposing a move and then accepting or rejecting it with a probability that corrects the proposal process.
...
## See why the normalizer cancels
...
## Retain proposal correction when needed
...
The next page in the sequence introduces [Hamiltonian Monte Carlo](hamiltonian-monte-carlo.qmd), which uses gradients to construct more directed proposals.
