...
The [foundations chapter](../foundations/linguistic-data.qmd) asked what one observation represents. We now ask the next question: which population are those observed units meant to represent? Suppose we record 30 speakers in Rochester and measure their production of a local vowel variable.
...
A population must be a population of something. Before we count rows, we must name that unit. It might contain
