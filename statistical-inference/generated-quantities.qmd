...
The three operations respectively compute a deterministic transformation of the joint parameter draw, simulate a future response, and evaluate the log density of an observed response.
...
These operations have different targets: replicated responses support posterior predictive checking, whereas pointwise log-likelihoods support predictive scoring and comparison.
...
The block supports reporting and prediction rather than constraints that should influence parameter learning.
