...
A [**paired design**](https://appliedstatisticsforlinguists.org/bwinter_stats_proofs.pdf#page=173) links two measurements because they arise from the same unit or from units matched before analysis. The pair, rather than either measurement alone, carries the contrast of interest. The question is how to turn those two linked measurements into one response at the independent-unit level. We do so by taking a within-pair difference.
...
Now, you might wonder whether differencing always makes an estimate more precise. The [variance and covariance rules from the preceding module](../random-variables-and-distributions/variance-and-covariance.qmd) give
