...
Notice that independence was not required for this expectation calculation. A common mean and linearity were enough. Independence matters for the usual standard-error formula, but it does not enter this particular proof of unbiasedness.

## Separate realized error from bias
...
The estimator is not simply biased or unbiased without qualification. Its bias depends on the parameter value. This dependence is why an analysis should state both the estimator and the model under which its behavior is being evaluated.
