...
The [**mass matrix**](https://mc-stan.org/docs/reference-manual/mcmc.html) gives HMC a constant scale and orientation for its momentum. This page develops that one geometric role and explains what Stan can learn during warmup.

## Generalize the kinetic energy
...
## Match velocity to posterior scale
...
## Distinguish three matrix structures
...
## Learn the matrix during warmup
...
The next page explains how the [No-U-Turn Sampler](no-u-turn-sampler.qmd) chooses a trajectory length after its geometric scales have been set.
