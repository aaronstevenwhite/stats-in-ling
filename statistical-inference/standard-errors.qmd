...
The [preceding page](properties-of-estimators.qmd) defined the sampling distribution of an estimator. Now we ask how spread out that distribution is. Its [**standard error**](https://appliedstatisticsforlinguists.org/bwinter_stats_proofs.pdf#page=173) is the standard deviation of that sampling distribution:
...
We first move the constant $1/n$ outside the variance. The square appears because [multiplying a random variable by a constant multiplies its variance by the constant squared](../random-variables-and-distributions/variance-and-covariance.qmd):
