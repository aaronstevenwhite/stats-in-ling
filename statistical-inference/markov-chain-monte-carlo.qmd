...
[Monte Carlo integration](monte-carlo-integration.qmd) used independent draws from a target distribution. Direct posterior draws are often unavailable. Can dependent draws still approximate the same expectation? [**Markov chain Monte Carlo (MCMC)**](https://bookdown.org/rdpeng/advstatcomp/markov-chain-monte-carlo.html) answers yes by using states from a [Markov chain](markov-chains.qmd) designed to have the posterior as its stationary distribution.
