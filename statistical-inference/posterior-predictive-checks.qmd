...
## Check complete and targeted features
...
## Preserve the dependence unit in the check
...
## Do not check only what the fit must match closely
...
## Interpret failure and success narrowly
...
## Separate model checking from model comparison
