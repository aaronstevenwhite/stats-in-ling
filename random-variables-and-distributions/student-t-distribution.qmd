...
The [normal distribution page](normal-distribution.qmd) introduced standardization when the population scale $\sigma$ is fixed. In data analysis, however, that scale is often unknown and replaced by a sample estimate. How does this additional uncertainty change the reference distribution of a standardized mean?

Let $X_1,\ldots,X_n$ be independent variables with common distribution $\mathcal N(\mu,\sigma^2)$. We first define their sample mean
...
The numerator $\overline X-\mu$ measures the sample mean's departure from the population mean. The denominator $S/\sqrt n$ estimates the scale of that departure. Under the stated normal and independence assumptions,

$$
\frac{\overline X-\mu}{S/\sqrt n}\sim t_{n-1}.
$$

Why does a new family appear rather than the standard normal family? The denominator is now random. More specifically, [**Student's t distribution**](https://online.stat.psu.edu/stat414/Lesson26) can be defined from two independent random variables. Let $Z\sim\mathcal N(0,1)$ and $U\sim\chi^2_\nu$, with $Z\perp\!\!\!\perp U$, and define
