...
The [preceding page](variance-and-covariance.qmd) defined variance as an expected squared deviation from the mean. That squaring prevents cancellation, but it also changes the measurement units. How do we retain the spread information while returning to the original scale? Suppose the modeled voice onset time variable $V$ has variance
...
The [**standard deviation**](https://bruno.nicenboim.me/bayescogsci/ch-intro.html) answers this question by taking the nonnegative square root of the variance:
