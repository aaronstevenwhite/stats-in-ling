...
The preceding pages introduced continuous distributions through their [probability density functions](probability-density-functions.qmd). Suppose a phonetic model represents an F1 measurement as varying symmetrically around 550 Hz. The density is highest at 550 and decreases as distance from 550 increases in either direction.
