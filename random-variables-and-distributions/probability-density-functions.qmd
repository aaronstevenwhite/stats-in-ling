...
The [preceding page](continuous-random-variables.qmd) explained why a continuous distribution assigns zero probability to an exact value. Suppose $R$ is the speaking rate of an utterance in syllables per second. A table of point masses thus cannot describe how probability is arranged across its support. If individual points have zero probability, what quantity lets us recover the probability of an interval?

Basically, we describe how quickly probability accumulates near each value and then compute interval probability as area. More specifically, a [**probability density function**](https://bruno.nicenboim.me/bayescogsci/ch-intro.html), abbreviated [**PDF**](https://bruno.nicenboim.me/bayescogsci/ch-intro.html), is a function $f_R:\mathbb R\to[0,\infty)$ satisfying
