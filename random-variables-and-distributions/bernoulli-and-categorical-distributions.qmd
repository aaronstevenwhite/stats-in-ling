...
## Collect the probabilities in a vector
...
This point matters in software. A factor level order may determine the position of a probability in an array without imposing an ordinal interpretation on the labels.

## Represent and sample the PMF in base R
...
## Keep labels and probabilities in the same order
