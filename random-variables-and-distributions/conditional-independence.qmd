...
The foundations chapter defined [independence for events](../foundations/independence.qmd), and the preceding pages extended probability to [joint distributions](joint-probability.qmd). Two annotations can be associated in a pooled corpus merely because both differ across genres, clause types, or speakers. How do we ask whether they remain associated after one such grouping variable is held fixed?

For a constructed illustration, suppose a corpus records subject omission $O$, verb final order $V$, and clause type $C$. The table values below are hypothetical and do not describe any particular language or corpus.
...
The [conditional probability factorization](../foundations/probability-factorization.qmd) gives
