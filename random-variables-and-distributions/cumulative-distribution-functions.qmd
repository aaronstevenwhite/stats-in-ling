...
Thus $F_B(180)=.72$ places $.72$ of the probability at or below 180, rather than above it. Writing the defining event $F_B(180)=\mathbb{P}(B\leq180)$ makes the direction explicit.
