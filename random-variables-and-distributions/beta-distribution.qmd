...
The [**beta distribution**](https://bruno.nicenboim.me/bayescogsci/ch-introBDA.html) is a family of continuous distributions on the open unit interval:
...
## Change the relative parameter sizes
...
## Hold the mean fixed while changing concentration
...
The larger equal parameters concentrate more density near $.5$. Equal means do not imply equal uncertainty about the latent preference.

## Inspect the shapes in base R
...
## Keep the modeled level explicit
