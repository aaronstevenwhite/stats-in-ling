...
The fact that a single point has zero probability follows from the density representation introduced on the next page. Probability is assigned across regions rather than as separate positive masses at each point.
