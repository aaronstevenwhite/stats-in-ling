...
The foundations chapter introduced the [joint probability of two events](../foundations/joint-probability-of-events.qmd). A [**joint distribution**](https://bruno.nicenboim.me/bayescogsci/ch-intro.html) is the distribution of a random vector such as $(P,R)$. Suppose each dialogue turn is annotated for two properties. Let $P$ record whether the turn contains a politeness marker, and let $R$ record whether it ends in a final pitch rise:
