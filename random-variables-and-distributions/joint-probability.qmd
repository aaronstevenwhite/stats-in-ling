...
This fact is central for linguistic association. If a final rise and a politeness marker tend to cooccur, the pattern concerns how their values are paired on the same turns, not only how frequent each annotation is separately. The observation key connecting both measurements to the same turn must therefore be retained.
