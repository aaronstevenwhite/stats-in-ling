...
\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Zipf's word frequency law in natural language: A critical review and future directions}\\
\phantom{\faBook\ }Steven T. Piantadosi\\
\phantom{\faBook\ }\href{https://doi.org/10.3758/s13423-014-0585-6}{doi.org/10.3758/s13423-014-0585-6}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Population samples}\\
\phantom{\faBook\ }Isabelle Buchstaller and Ghada Khattab\\
\phantom{\faBook\ }\href{https://doi.org/10.1017/CBO9781139013734.006}{doi.org/10.1017/CBO9781139013734.006}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Acoustic characteristics of American English vowels}\\
\phantom{\faBook\ }James Hillenbrand, Laura A. Getty, Michael J. Clark, and Kimberlee Wheeler\\
\phantom{\faBook\ }\href{https://doi.org/10.1121/1.411872}{doi.org/10.1121/1.411872}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Cross-validation}\\
\phantom{\faBook\ }Bruno Nicenboim, Daniel Schad, and Shravan Vasishth\\
\phantom{\faBook\ }\href{https://bruno.nicenboim.me/bayescogsci/ch-cv.html}{bruno.nicenboim.me/bayescogsci/ch-cv.html}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{The Natural Stories Corpus}\\
\phantom{\faBook\ }Richard Futrell, Edward Gibson, Harry Tily, Idan Blank, Anastasia Vishnevetskaya, Steven T. Piantadosi, and Evelina Fedorenko\\
\phantom{\faBook\ }\href{https://aclanthology.org/L18-1012/}{aclanthology.org/L18-1012}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Limits on lexical prediction during reading}\\
\phantom{\faBook\ }Steven G. Luke and Kiel Christianson\\
\phantom{\faBook\ }\href{https://doi.org/10.1016/j.cogpsych.2016.06.002}{doi.org/10.1016/j.cogpsych.2016.06.002}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{The Provo Corpus}\\
\phantom{\faBook\ }Steven G. Luke and Kiel Christianson\\
\phantom{\faBook\ }\href{https://doi.org/10.3758/s13428-017-0908-4}{doi.org/10.3758/s13428-017-0908-4}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Analyzing linguistic diversity using Poisson regression; adding exposure variables}\\
\phantom{\faBook\ }Bodo Winter\\
\phantom{\faBook\ }\href{https://appliedstatisticsforlinguists.org/bwinter_stats_proofs.pdf}{appliedstatisticsforlinguists.org/bwinter\_stats\_proofs.pdf}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{French liaison is allomorphy, not allophony: Evidence from lexical statistics}\\
\phantom{\faBook\ }Enrico Storme\\
\phantom{\faBook\ }\href{https://doi.org/10.1007/s11525-024-09429-8}{doi.org/10.1007/s11525-024-09429-8}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Factivity, presupposition projection, and the role of discrete knowledge in gradient inference judgments}\\
\phantom{\faBook\ }Julian Grove and Aaron Steven White\\
\phantom{\faBook\ }\href{https://doi.org/10.1007/s11050-025-09244-9}{doi.org/10.1007/s11050-025-09244-9}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{The independence assumption; dealing with non-independence via experimental design and averaging}\\
\phantom{\faBook\ }Bodo Winter\\
\phantom{\faBook\ }\href{https://appliedstatisticsforlinguists.org/bwinter_stats_proofs.pdf}{appliedstatisticsforlinguists.org/bwinter\_stats\_proofs.pdf}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Predicting the Dative Alternation}\\
\phantom{\faBook\ }Joan Bresnan, Anna Cueni, Tatiana Nikitina, and R. Harald Baayen\\
\phantom{\faBook\ }\href{https://web.stanford.edu/~bresnan/qs-submit.pdf}{web.stanford.edu/{\textasciitilde}bresnan/qs-submit.pdf}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{The CommitmentBank: Investigating projection in naturally occurring discourse}\\
\phantom{\faBook\ }Marie-Catherine de Marneffe, Mandy Simons, and Judith Tonhauser\\
\phantom{\faBook\ }\href{https://ojs.ub.uni-konstanz.de/sub/index.php/sub/article/view/601}{ojs.ub.uni-konstanz.de/sub/article/view/601}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Final devoicing before it happens: A large-scale study of word-final obstruents in French}\\
\phantom{\faBook\ }Adèle Jatteau et al.\\
\phantom{\faBook\ }\href{https://doi.org/10.16995/labphon.10855}{doi.org/10.16995/labphon.10855}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Aspectual similarity predicts sense similarity}\\
\phantom{\faBook\ }Aaron Steven White, Scott Grimm, and Lelia Glass\\
\phantom{\faBook\ }\href{../readings/white-grimm-glass-2026-aspectual-similarity.pdf}{Course PDF}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Control methods used in a study of the vowels}\\
\phantom{\faBook\ }Gordon E. Peterson and Harold L. Barney\\
\phantom{\faBook\ }\href{https://doi.org/10.1121/1.1906875}{doi.org/10.1121/1.1906875}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Frequency, acceptability, and selection: A case study of clause-embedding}\\
\phantom{\faBook\ }Aaron Steven White and Kyle Rawlins\\
\phantom{\faBook\ }\href{https://doi.org/10.5334/gjgl.1001}{doi.org/10.5334/gjgl.1001}
\end{tcolorbox}

\begin{tcolorbox}[colback=white,colframe=accentblue,boxrule=0.5pt,arc=2mm]
\faBook\ \textbf{Decomposing and recomposing event structure}\\
\phantom{\faBook\ }William Gantt, Lelia Glass, and Aaron Steven White\\
\phantom{\faBook\ }\href{https://aclanthology.org/2022.tacl-1.2/}{aclanthology.org/2022.tacl-1.2}
\end{tcolorbox}
...
\faTasks\ Final Project & N/A & \textbf{40\%} & \href{https://aaronstevenwhite.io/stats-in-ling/final_project/rubric/final_project_rubric.pdf}{See rubric}\\
\bottomrule
\end{tabular}
\end{tcolorbox}
\end{center}
...
\end{enumerate}
\vspace{1em}
\faBook\ \textit{See the \href{https://aaronstevenwhite.io/stats-in-ling/final_project/rubric/final_project_rubric.pdf}{Final Project Rubric} for detailed requirements and grading criteria}
\end{tcolorbox}
