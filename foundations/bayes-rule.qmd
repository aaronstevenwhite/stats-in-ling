...
This identity is [**Bayes' rule**](https://bruno.nicenboim.me/bayescogsci/ch-intro.html). It follows from applying the chain rule to one joint probability in two orders. No independence assumption is used.
