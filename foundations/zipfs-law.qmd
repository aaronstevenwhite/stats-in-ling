...
Here $f(r)$ is the observed token count, whereas $\widehat f(r)$ is the count predicted by the model. The parameter $\alpha$ controls how quickly predicted frequency falls as rank rises.
...
For an illustrative inverse-rank curve, set $\alpha=1$ and anchor the curve at the observed rank 1 count. The prediction is
