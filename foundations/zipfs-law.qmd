...
The plots raise two separate questions.
...
A useful account must make additional predictions. For instance, it might predict which meanings receive frequent forms, how the curve changes in a restricted genre, how local frequencies change through a text, or where syntactic categories depart from the overall pattern.
