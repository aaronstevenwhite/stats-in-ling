...
The first requirement rules out negative probabilities. The second assigns probability one to the certain event. The third tells us how to compute the probability of a union when its events are pairwise disjoint.
