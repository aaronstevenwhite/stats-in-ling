...
## I study linguistic representations
...
## Those data raise statistical questions
...
A statistical model for these responses must allow both endpoints and interior values.
...
A model must account for variation across participants and items.
...
An analysis must state which measurements are missing and test whether a proposed completion recovers held out observations.
